namespace GO.Tools {
    ...
    export class RevelationProgressViewModel {

        Years: KnockoutObservableArray<Item> = ko.observableArray<Item>([]);
        Events: KnockoutObservableArray<Item> = ko.observableArray<Item>([]);
    ...
    class Item {
        ...
        constructor(location: string, type: string, title: string) {
            this.Title = title;
            //this.Type = type;

    ...
    (function (Tools) {
        class LandingViewModel {
                    ...
                    if (state && state.Parameters.page) {
                        ...
                        switch (state.Parameters.page) {
                            ...
                            case 'namesplaces':
                                ...
                                return;
                            case 'revelation-progress':
                                go.ActivePage('go-tools-revelationProgress');
                                return;
            ...
            SetupImageLinks() {
                ...
                this.ImageLinks.push(new GO.ImageLink('Revelation Progress Tracker', '<p>The Revelation Progress Tracker will attempt to match world events to what we are seeing in the Revelation Timeline.</p>', '/tools/revelation-progress', 'RevelationProgressTracking-Small.jpg'));
